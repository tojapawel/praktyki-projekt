    ...
    <div className="container py-4">
      <div className="p-5 mb-4 text-bg-dark rounded-3">
        <div className="container-fluid py-5">
          ...
          <p className="col-md-8 fs-4">{t("hotels.hotelsList.info")}</p>
        </div>
      </div>
            ...
            <div className="container my-5">
              <div className="p-5 text-center">
                <h1 className="text-body-emphasis">
                  {t("hotels.hotelsList.emptyHotels.noHotels")}
                </h1>
                <p className="mx-auto fs-5 text-muted">{t("hotels.hotelsList.emptyHotels.info")}</p>
              </div>
            </div>
          )}
        </div>
