    ...
    <div className={styles.bgimage}>
      <div className={styles.bgoverlay}>
        <div className={`container col-xl-10 col-xxl-8 px-4 py-5 vertical_center `}>
          ...
          <div className="row align-items-center g-lg-5 py-5">
            ...
            <div className="col-md-10 mx-auto col-lg-5">
              <div
                ...
                <a
                  href=""
                  className={`w-100 btn btn-lg btn-primary mb-3 ${disabled}`}
                  onClick={handleSearch}>
                  {t("main.button.main.searchHotels")}
                </a>

                <hr className="my-4" />
                <small className="text-body-secondary">
                  <a href="" onClick={handleAllHotels}>
                    {t("main.button.main.allHotels")}
                  </a>
                </small>
              </div>
            </div>
          ...
          {!cookieClosed && (
            <div
              className="alert alert-primary alert-dismissible fade show position-absolute bottom-0"
              role="alert">
              {t("main.cookies")}
              <button
                type="button"
                ...
                aria-label="Close"
                onClick={handleSaveCookies}></button>
            </div>
          )}
        </div>
      </div>
